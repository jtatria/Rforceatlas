...
#' @family graph layout
#' @export
forceatlas <- function(m, iter = 100L, linlog = FALSE, nohubs = FALSE, k = 400L, G = 1L, ks = 0.1, ksmax = 10.0, delta = 1.0, tol = 0.1, dim = 2L, init = NULL, center = NULL) {
    .Call('_Rforceatlas_forceatlas', PACKAGE = 'Rforceatlas', m, iter, linlog, nohubs, k, G, ks, ksmax, delta, tol, dim, init, center)
}
