...
attr_func <- function(k, d, deg_i, wgt, linlog, nohubs, overlap) {
    .Call('_Rforceatlas_attr_func', PACKAGE = 'Rforceatlas', k, d, deg_i, wgt, linlog, nohubs, overlap)
}

repl_func <- function(k, d, deg_i, deg_j, overlap) {
    .Call('_Rforceatlas_repl_func', PACKAGE = 'Rforceatlas', k, d, deg_i, deg_j, overlap)
}

grav_func <- function(k, d, deg_i, G, strong) {
    .Call('_Rforceatlas_grav_func', PACKAGE = 'Rforceatlas', k, d, deg_i, G, strong)
}
...
#' @family graph layout
#' @export
forceatlas <- function(m, iter = 100L, linlog = FALSE, nohubs = FALSE, k = 1.0, G = 1L, strong = FALSE, ks = 0.1, ksmax = 10.0, delta = 0.0, tol = 0.1, dim = 2L, init = NULL, center = NULL) {
    .Call('_Rforceatlas_forceatlas', PACKAGE = 'Rforceatlas', m, iter, linlog, nohubs, k, G, strong, ks, ksmax, delta, tol, dim, init, center)
}
